...
const StudentForm = () => {
  return (
    <div className={classes['container']}>
      ...
      <h2 style={{fontWeight:'500'}}>Welcome <span style={{color:'red'}}>Student</span> get ready </h2>
      <h2 style={{fontWeight:'500'}}> to Learn</h2>
      </div>
      <div className={classes['container__inside']}>
          <div className={classes['container__left']}>
          <div className={classes['student']}>
          <img src="https://iili.io/mP0uWu.png"/>
          </div>
          ...
          <Nav className={classes['join-now']} to='/join' >JoinNow</Nav>
          </div>
